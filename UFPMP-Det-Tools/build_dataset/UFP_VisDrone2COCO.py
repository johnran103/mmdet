...
def main():
    ...
    for key in range(size):
        ...
        for bbox in rec:
            ...
            t_bbox = [x1, y1, x1 + w, y1 + h] # foreground box
            g_bboxes = [n_x, n_y, w*scale_factor, h*scale_factor] # packed box
            generate_bboxs.append(g_bboxes)
        ...
        big_box = {'generate_bboxs':generate_bboxs,
                   'id':key,
                   'file_name': img_name
                  }
