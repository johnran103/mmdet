...
def main():
    ...
    for _dir in os.listdir(root):
        if _dir not in testset:
            continue
        gt_path = os.path.join('/home/ranqinglin/work_dirs/ddet/data/UAVDT/UAV-benchmark-MOTD_v1.0/GT',_dir+'_gt_whole.txt')
        gt_ignore_path = os.path.join('/home/ranqinglin/work_dirs/ddet/data/UAVDT/UAV-benchmark-MOTD_v1.0/GT',_dir+'_gt_ignore.txt')
