...
def main():
    ...
    for key in range(size):
        ...
        filename=os.path.join('/home/ranqinglin/work_dirs/ddet/visdrone_val_output',img_name)
        ori_filename=os.path.join(dataset_root,img_name)    
        #imshow_det_bboxes(ori_filename, all_boxes, all_categories,class_names=CLASSES, out_file=filename)
