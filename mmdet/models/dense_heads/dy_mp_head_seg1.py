...
class attention1d(nn.Module):
    def __init__(self, in_planes=9, ratios=16, K=4, temperature=1, init_weight=True): # quality map
...
class DYMPHeadSeg1(GFLHead):
    ...
    def __init__(self,
        ...
        super(DYMPHeadSeg1, self).__init__(**kwargs)

        self.atten1 = attention1d(in_planes=9, ratios=16, K=4, temperature=34)
        in_channel = 256 * 5
    ...
    def aug_test_bboxes(self, feats, img_metas, rescale=False, scale_maps=None, quality_maps=None):
        ...
        aug_scores = []
        aug_labels = []
        for x, img_meta, scale_map in zip(feats, img_metas, scale_maps):
            # only one image in the batch
            outs = self.forward(x, scale_map=scale_map)
