...
class attention1d(nn.Module):
    def __init__(self, in_planes=10, ratios=16, K=4, temperature=1, init_weight=True): # quality map
...
class Dynamic_conv1d(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, ratio=16.0, stride=1, padding=0, dilation=1, bias=True, K=4,temperature=34, init_weight=True):
        ...
        self.bias = bias
        self.K = K
        self.attention = attention1d(9, ratio, K, temperature)
...
class DYMPHeadSeg2(GFLHead):
    ...
    def __init__(self,
        ...
        super(DYMPHeadSeg2, self).__init__(**kwargs)

        self.atten1 = attention1d(in_planes=10, ratios=16, K=4, temperature=34)
        in_channel = 256 * 5
    ...
    def refine_feat_by_scale(self, feats, scale_map=None):
        ...
        #print(torch.cat(_feats).mean(dim=1,keepdim=True).size())
        #print(scale_map.size())
        scale_map = torch.cat([torch.cat(_feats,dim=1).mean(dim=1,keepdim=True), scale_map],dim=1)
