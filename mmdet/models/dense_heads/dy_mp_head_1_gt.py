...
class DYMPHead1GT(GFLHead):
    ...
    def __init__(self,
        ...
        super(DYMPHead1GT, self).__init__(**kwargs)
    ...
    def simple_test_bboxes(self, feats, img_metas, rescale=False, scale_maps=None, quality_maps=None):
        ...
        outs = self.forward(feats, scale_map=scale_maps[0], quality_map=quality_maps[0])
