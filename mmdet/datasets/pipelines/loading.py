...
class LoadDensityMap:
    ...
    def __call__(self, results):
        ...
        if results['img_prefix'] is not None:
            filename = osp.join('/home/ranqinglin/work_dirs/ddet/train/dens/',
                                results['img_info']['filename'].replace('.jpg', '.npy'))
        else:
            filename = results['img_info']['filename']
        
        img = np.load(filename)
        results['density_map'] = img
        results['density_map_fields'] = ['density_map']
...
class LoadQualityMap:
    ...
    def __call__(self, results):
        ...
        if results['img_prefix'] is not None:
            filename = osp.join('/data0/ranqinglin/ddet/data/VisDrone_Dataset_COCO_Format/images/train_quality_map/',
                                results['img_info']['filename'].replace('.jpg', '.npy'))
        else:
            filename = results['img_info']['filename']
        
        img = np.load(filename)
        results['quality_map'] = img
        results['quality_map_fields'] = ['quality_map']
...
class LoadQualityMapTest:
    ...
    def __call__(self, results):
        ...
        if results['img_prefix'] is not None:
            filename = osp.join('/data0/ranqinglin/ddet/data/VisDrone_Dataset_COCO_Format/images/test_quality_map/',
                                results['img_info']['filename'].replace('.jpg', '.npy'))
        else:
            filename = results['img_info']['filename']
...
class LoadScaleMap:
    ...
    def __call__(self, results):
        ...
        if results['img_prefix'] is not None:
            filename = osp.join('/data0/ranqinglin/ddet/data/VisDrone_Dataset_COCO_Format/images/train_scale_map/',
                                results['img_info']['filename'].replace('.jpg', '.npy'))
        else:
            filename = results['img_info']['filename']
        
        img = np.load(filename)
        results['scale_map'] = img
        results['scale_map_fields'] = ['scale_map']
...
class LoadScaleMapTest:
    ...
    def __call__(self, results):
        ...
        if results['img_prefix'] is not None:
            filename = osp.join('/data0/ranqinglin/ddet/data/VisDrone_Dataset_COCO_Format/images/test_scale_map_mobilenet/',
                                results['img_info']['filename'].replace('.jpg', '.npy'))
            print(filename)
        else:
            filename = results['img_info']['filename']
        
        img = np.load(filename)[0,0]
        #print(img.shape)
        results['scale_map'] = img
        results['scale_map_fields'] = ['scale_map']
