...
from dataloader import ScaleDataset
...
checkpoint = torch.load('./checkpoints_cos/epoch_39.pth',map_location='cpu')        # 从本地读取
...
#gt_dmap_root_test = './dummy_gt_test'
img_root = '/home/ranqinglin/work_dirs/ddet/data/VisDrone_Dataset_COCO_Format/images/instances_UFP_UAVval'
save_root = '/home/ranqinglin/work_dirs/ddet/data/VisDrone_Dataset_COCO_Format/images/test_scale_map_mobilenet'

#test_dataset = ScaleDataset(img_root_test,gt_dmap_root_test,4)
...
with torch.no_grad():
    ...
    for img_name in os.listdir(img_root):
        ...
        np.save(os.path.join(save_root, img_name.replace('jpg', 'npy')), img_output.cpu().numpy())
