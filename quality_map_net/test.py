...
img_root = './dummy_input_test'

checkpoint = torch.load('./checkpoints_aug/epoch_9.pth',map_location='cpu')        # 从本地读取
...
img_root_test = './dummy_input_test'


#test_dataset = QualityDataset(img_root_test,gt_dmap_root_test,4)
...
with torch.no_grad():
    img_scale = (1332,1332)
    img_name = '0000364_01373_d_0000780.jpg'
