...
model = dict(
    ...
    scale_path='/home/ranqinglin/work_dirs/ddet/scale_map_net/ckpt/checkpoints_seg/epoch_11.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1332, 1332), keep_ratio=True),
...
custom_hooks = [
    ...
    dict(type='DyConvHook', priority='HIGHEST', per_iter=4045)
]