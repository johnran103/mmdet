...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_density_map=dict(type='MSELoss', loss_weight=1.0),
        reg_max=16,
...
train_pipeline = [
    ...
    dict(type='LoadDensityMap'),
    dict(type='ResizeWithDensityMap', img_scale=(1300, 800), keep_ratio=True),
    dict(type='RandomFlipWithDensityMap', flip_ratio=0.5),
    dict(type='Normalize', **img_norm_cfg),
    dict(type='PadWithDensityMap', size_divisor=32),
    # dict(
    #     type='Albu',
    ...
    dict(type='DefaultFormatBundleWithDesityMap'),
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels', 'density_map']),
]
